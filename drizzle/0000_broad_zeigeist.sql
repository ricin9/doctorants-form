...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "doctorate_registration" ADD CONSTRAINT "doctorate_registration_thesis_director_details_directeur_these_id_fk" FOREIGN KEY ("thesis_director_details") REFERENCES "directeur_these"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "doctorate_registration" ADD CONSTRAINT "doctorate_registration_thesis_co_director_details_directeur_these_id_fk" FOREIGN KEY ("thesis_co_director_details") REFERENCES "directeur_these"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
